...
/**
 * LinkButtonAction - open URL button aciton 
 */
...
/**
 * Image element, url must be whitelisted with Live Person Service
 */
...
export class QuickReply
{
    ...
    constructor(value :string, title :string)
    {
        ...
        this.tooltip = title;
        this.title = title;
        this.click = {"actions":[new PostBackButtonAction(value)],"metadata":[{type: "ExternalId",id: "ExternalIdValue"}]}
    }
}
